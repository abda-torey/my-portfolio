...
const Articles = () => {
  ...
  const newsData = [
    {
      img: "assets/img/portfolio/preview.png",

      date: "February 20, 2024",

      title: "Analysis of Whatsap Group chat using Machine learning techniques",
    },
    // {
                      ...
                      <div className="details relative pl-[30px] ml-[29px]">
                        ...
                        <div className="post_title">
                          <h3 className="m-0 p-0 leading-[1] font-semibold">
                            <a
                              href="https://medium.com/@gedi5685/analyzing-whatsapp-group-chat-0c9d14d0b06b"
                              target="_blank"
                            >
                              {news.title}
                            </a>
